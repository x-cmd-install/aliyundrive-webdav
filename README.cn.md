...
[![x-cmd/install — aliyundrive-webdav Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/aliyundrive-webdav.svg?lang=zh)](https://x-cmd.com/install/aliyundrive-webdav)
...
合计: **3,282** 行代码（覆盖前 5 种语言、共 **19** 个文件）。
...
- **上游仓库**: <https://github.com/messense/aliyundrive-webdav>
- **许可证**: MIT
...
- **Star**: 9,757 · **Fork**: 1,065 · **开放 issue**: 358 · **贡献者**: 19

## 累计统计

- **发布数**: 117 · **已合并 PR**: 150 · **开放 PR**: 8 · **已关闭 issue**: 341 · **开放 issue**: 17 · **提交数**: 852
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/aliyundrive-webdav.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T05:09:30Z._
